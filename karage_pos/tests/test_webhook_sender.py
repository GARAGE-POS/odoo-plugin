...
class TestWebhookSender(KaragePosTestCommon):
    """Test webhook sender model"""

    @patch("custom_addons.karage_pos.models.webhook_sender.requests")
    def test_send_webhook_success(self, mock_requests):
        ...
        self.assertEqual(
            call_args[0][0], "http://test.odoo.com/api/v1/webhook/pos-order"
        )
