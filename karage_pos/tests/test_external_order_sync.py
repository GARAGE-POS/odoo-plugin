...
class TestExternalOrderSync(TransactionCase):
    ...
    @patch('custom_addons.api_integration.models.external_order_sync.ExternalOrderSync._fetch_orders_from_external')
    @patch('custom_addons.api_integration.models.external_order_sync.ExternalOrderSync._process_external_order')
