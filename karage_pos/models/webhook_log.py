...
class WebhookLog(models.Model):
    ...
    def update_log_result(self, status_code=None, response_message=None, 
                         success=False, pos_order_id=None, 
                         idempotency_record_id=None, processing_time=None):
        ...
        update_vals = {
            ...
            'idempotency_record_id': idempotency_record_id.id if idempotency_record_id else False,
        }
